...
export default function ExplorePage() {
  ...
  return (
    <SmoothScroll>
      <div ref={containerRef} className="relative bg-cyan-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {healthCategories.map((category, i) => (
              <motion.div
                ...
                className="group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all cursor-pointer border border-cyan-100"
              >
